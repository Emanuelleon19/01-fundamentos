...
public class UserServiceImpl implements UserService {
    ...
    public UserResponseDto partialUpdate(Long id, PartialUpdateUserDto dto) {
        ...
        if (dto.getPassword() != null) {
            // Reutiliza la lógica de hashing/encriptación del mapper mapeando un DTO temporal
            CreateUserDto tempDto = new CreateUserDto();
            tempDto.setPassword(dto.getPassword());
            
            UserModel tempModel = UserMapper.toModelFormDTO(tempDto);
            entity.setPasswordHash(tempModel.getPasswordHash());
        }
